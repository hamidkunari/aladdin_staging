...
<header class="main-header">
    <!-- Logo -->
    <a style="background-color:#024C26" href="{{ url('/') }}" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b>Ala</b>din1</span>
        <!-- logo for regular state and mobile devices -->
        <!-- <img src="{{ \Settings::get('site_logo') }}" class="" style="max-height: 30px;"/> -->
        <img src="{{asset('uploads/settings/logo.png')}}" style="max-height: 30px;">
    </a>
