<!-- Site Footer-->
<footer class="site-footer" style="background-color: #229954">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6">
                ...
                <section class="widget widget-light-skin">
                    ...
                    <p class="text-white">@lang('corals-marketplace-master::labels.partial.mobile') +01156311830 </p>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="" style="display: table;height: 100%;">
                    <a class="footer-logo" style="display: table-cell;vertical-align: middle;" href="{{ url('/') }}">
                        <img src="{{asset('uploads/settings/logo.png')}}" alt="{{ \Settings::get('site_name', 'Corals') }}">
                    </a>
                </div>
            </div>
        </div>
        ...
        <p class="footer-copyright">
            ...
            <p style="color:white; font-weight: bold; padding-bottom: 30px;">©Copyright 2021 | Aladdin Group | All Rights Reserved.</p>
        </p>
