<div class="item text-center col-md-3">
    <div style="border-radius: 5px; border:solid 2px #F2F3F4; margin: 0px 0px 10px 0px;" class="product-miniature js-product-miniature item-one first-item">
        <div>
            <a style="height: 150px;" href="{{ url('shop/'.$product->slug) }}">
                <img style="height: 150px" class="img-fluid image-secondary" src="{{ $product->non_featured_image  }}"
                     alt="img">
