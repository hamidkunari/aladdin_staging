...
<style type="text/css">
   ...
   #product-detail .content .main-product-detail .product-info .detail-description .has-border .product-quantity .input-group .add .add-to-cart, #product-detail .content .main-product-detail .product-info .detail-description .has-border .product-quantity .input-group .add a {
        background: #086D38;
    }
</style>
@endsection
         ...
         <div class="col-sm-8 col-lg-9 col-md-9">
            <div class="main-product-detail">
               <div class="product-single row">
                  <div class="product-detail col-xs-12 col-md-6 col-sm-6">
                     <div class="page-content" id="content">
                        ...
                        <ul class="product-tab nav nav-tabs d-flex">
                           @foreach($medias as $media)
                           <li class="{{ $media->getCustomProperty('featured', false)?'active':'' }} gal-thumb">
                              <a href="#gItem_{{ $media->id }}" data-hash="gItem_{{ $media->id }}"
                                 data-toggle="tab">
                              <img style="width: auto; height: 100px" src="{{ $media->getFullUrl() }}" alt="img">
                              </a>
                           </li>
                           @endforeach
                        </ul>
                  ...
                  <div class="product-info col-xs-12 col-md-6 col-sm-6">
                     <div class="detail-description">
                         
                        <div class="price-del">
                           <small>{{$product->slug}}</small>
                           <h2>{{ $product->name }}</h2>
                           &nbsp;@lang('corals-marketplace-pro::labels.template.product_single.store')
                           :
                           <span class="content2">
                           <a
                              href="{{ $product->store->getUrl() }}">{{ $product->store->name }}</a>
                           &nbsp;@lang('corals-marketplace-pro::labels.template.product_single.category')
                           :
                        ...
                        <div class="d-flex flex-wrap">
                           @endif
                           <div class="text-center sku-item mr-2" style="width: 200px; height: 100px">
                        ...
                        <div class="product-quantity">
                           <div class="qty">
                              <div class="input-group">
                                 ...
                                 <span class="add">
                                 @if($product->external_url)
                                 <a style="background-color:green" href="{{ $product->external_url }}" target="_blank"
                                    class=""
                     ...
                     <span style="font-size: 20px;" class="price">{!! $product->price !!}</span>
                     <div class="content2 has-border" id="product-additionals">
                        <p>
