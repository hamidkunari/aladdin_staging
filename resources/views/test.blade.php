...
<body>
    ...
    <div id="homepage-1" class="row">
        ...
        <div class="col-lg-10 livebox">
            <img class="img-fluid" src="{{asset('uploads/slider/banner2.jpg')}}">
            <div class="row">
             <div class="col-lg-11">
              <br>
               <h6 style="margin: -0px 0px -10px 10px">Featured Livestream</h6>  
            <div class="row">   
                <a href="watchstream">
            <div class="col-xs-4 col-lg-3 featurelive">
                <a href="watchstream" style="color:red">Live </a> <span><i class="fa fa-eye"></i> 0</span>
            </div>
              <div class="col-xs-4 col-lg-3 featurelive">
                <a href="watchstream" style="color:red">Live </a> <span><i class="fa fa-eye"></i> 0</span>
            </div>
