...
<body>
            ...
            <div class="ps-container">
                ...
                <div class="header__center">
                    <form class="ps-form--quick-search" method="get" action="{{ url('shop') }}">
                        ...
                        <input class="form-control" type="text" name="search" style="border-top-left-radius: 20px;border-bottom-left-radius: 20px; font-size: 13px" placeholder="Trending Products..." id="input-search">
                        <button type="submit" style="background-color: #086E38; border-top-right-radius: 20px;border-bottom-right-radius: 20px; font-size: 13px;">Search</button>
    ...
    <header class="header header--mobile" data-sticky="true" style="background-color: #086E38">
        ...
        <div class="navigation--mobile">
            <div class="navigation__left" ><a class="ps-logo"  href="#"><img class="scroll_logo" src="{{asset('uploads/settings/logo2.png')}}" alt=""></a></div>
            <div class="navigation__right">
        ...
        <div class="ps-search--mobile">
            <form class="ps-form--search-mobile"  method="get" action="{{ url('shop') }}">
                <div class="form-group--nest">
                    ...
                    <button style=""><i class="icon-magnifier"></i></button>
                </div>
            </form>
        </div>
    </header>
...
<div id="full-screen-video" style="margin: 0px 0px 0px 0px"></div>
<div id="watch-live-overlay">
                    <div id="overlay-container">
                

                            <div class="col-md text-center" style="margin-top: 130px;">
                                    <button id="watch-live-btn" type="button" class="btn btn-block btn-success btn-xlg">
          ...
          <div class="col-lg-4 mt-4 comment">
          <p style="margin-bottom: -5px">Comments</p>
          <hr>
          <div class="media overflow-auto" style="height: 300px">
...
<hr>
          <form class="ps-form--quick-search" style="margin-bottom: 10px" action="" method="get">
           <input class="form-control" type="text" style="border-top-left-radius: 20px;border-bottom-left-radius: 20px; height: 30px;" placeholder="Trending Products..." id="input-search">
                        <button type="submit" class="btn btn" style="background-color: #086E38; border-top-right-radius: 20px;border-bottom-right-radius: 20px;">submit</button>
...
<br>
<p>Product Featured in Livestream</p>
<div class="row" style="margin: 10px">

<div class="col-xs-6 col-lg-4 calpro1">
              <div class="col-xs-3 col-lg-5"><img height="80" width="80" class="proimg" src="{{asset('uploads/product/watch.jpg')}}"></div>
    <div class="col-xs-3 col-lg-7"><small>Cheps</small>
     <br>
     <strong>Potato cheps</strong><br>
     <p>RM32</p><a href="#" style="margin-left: 10px; height: 25px; width: 25px; border-radius: 50px; background-color: #E5E7E9; color:white; padding: 5px 0px 0px 5px;" class="fa fa-shopping-cart" aria-hidden="true"></a>
  ...
  <div class="col"><img class="footer_country"  src="{{asset('uploads/footer/uk.png')}}"></div>
            ...
            <li><a class="text-right ">Help Center</a> </li>
               ...
               <div class="row" style="display: inline;">
                  <h5 class="icons">Follow Us</h5><br>
                 ...
                 <h5 class="footer_logo">A product by</h5>
               <div class="row">
