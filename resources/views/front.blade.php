   ...
   <body>
         ...
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="container clearfix">
               <ul class="nav pull-left">
                  <li><a class="top" style="color:#086E38; font: poppins;" href="{{url('landing-page')}}"><i class="fas fa-globe-asia"></i> Malaysia |</a></li>
                  <li id="menu-item-121763" class="top-bar-text menu-item "><a class="top" style="color:#086E38; font: poppins"  href="#">MYR |</a></li>
                  <li  class="top-bar-text menu-item"><a class="top" style="color:#086E38"  href="#">English</a></li>
               </ul>
               <ul id="menu-top-bar-right" class="nav nav-inline pull-right">
                  <li class="top-bar-text menu-item "><a class="top" style="color:#086E38; font: poppins"  href="https://aladdin1.my/track-your-order/"><i class="fas fa-truck"></i>Track Your Order |</a></li>
                  <li  class="vendor top-bar-text"><a class="top" style="color:#086E38; font: poppins"  href="{{url('dashboard')}}/"><i class="far fa-user-circle"></i> 
                     @auth
      ...
      <!-- header desktop -->
         ...
         <div class="container" >
            ...
            <div class="topnav" id="myTopnav">
               ...
               <a href="{{ url('shop?category='.$category->slug) }}" style="color:white; font: POPPINS ; text-decoration: none; margin-top: 7px; margin-right: 10px" class="nav-link">
               ...
               @endforeach
               @endif
               <a href="newarrivel" style="color:white; font: POPPINS ; text-decoration: none; margin-top: 7px; padding-bottom: -2px;">New Arrivals</a>
               <a href="live" style="color:white; font: POPPINS ; width: auto; padding-top: -10px;  text-decoration: none; margin-top: 7px">Aladdin1 Live & Group Buy
</a>
      ...
      <div class="container">
                           ...
                           <div id="myCarousel" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner">
                                 <div class="item active">
                                       ...
                                       <a href="{{ url('shop?category='.$category->slug) }}"><img class="slid" style="height: 150px;  margin-top: 5px;  image-resolution: from-image 300dpi;" src="{{asset('uploads/slider/skin.png')}}"></a>
                                       ...
                                       <div class="row" style="margin-top: 5px;">
                                          ...
                                          <div class="col-xs-12 col-lg-5 calpro1">
                                             <div class="col-xs-5 col-lg-5"><img class="proimgg" src="{{ $product->non_featured_image }}"></div>
         ...
         <div class="container con1">
            <div class="row" style="margin-bottom: 50px">
               <h3 class="text-center"><span style="color:#086E38"></span><span style="margin:0px 15px 0px 15px; font: poppins;
                  letter-spacing: 0.42px;
                  color: #086E38;
                  opacity: 1; ">Top Categories</span><span style="color:#CACFD2"></span></h3>
               ...
               <div class="row product" style="margin-bottom: 10px;">
                  <div class="row" style="border-bottom:solid 2px #CACFD2; width: 92%; margin-bottom: 10px; padding-bottom: -10px; margin-left: 5px;">
                  <div class="col-xs-9 col-md-9  col-lg-10">
                     <h3>Best Selling Products to Discover</h3>
                  </div>
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 calpro6">
                     <div class="col-xs-5 col-lg-5"><img class="proimg" src="{{ $product->non_featured_image }}"></div>
                     <div class="col-xs-7 col-lg-7"><small>{{$product->slug}}</small>
                        <br>
                        <strong>{{$product->name}}</strong><br>
                        <small>{{$product->price}}</small>
                        <br>
                        <a style="color:grey;" href="{{ $product->store->getUrl() }}">{{$product->store->name }}</a>
                        <a href="{{ url('shop', $product->slug) }}"><i style="margin-left: 10px; height: 25px; width: 25px; border-radius: 50px; background-color: #E5E7E9; color:white; padding: 5px 0px 0px 5px;" class="fa fa-shopping-cart" aria-hidden="true"></i></a>
                     </div>
                  </div>
                  @endforeach
                           ...
                           <div class="col-xs-12 col-lg-12">
                              <div class="row" style="margin-top: 5px;">
                                 ...
                                 <div class="col-xs-12 col-lg-6 calpro6">
                                    <div class="col-xs-4 col-lg-3"><img class="proimg" src="{{ $product->non_featured_image }}"></div>
                                    <div class="col-xs-8 col-lg-8">
                                       <strong>{{$product->name}}</strong><br>
                                       <small>{{$product->price}}</small><a href="{{ url('shop', $product->slug) }}"><i style="margin-left: 10px; height: 25px; width: 25px; border-radius: 50px; background-color: #E5E7E9; color:white; padding: 5px 0px 0px 5px;" class="fa fa-shopping-cart" aria-hidden="true"></i></a>
                                    </div>
                                 </div>
                                 <?php $count++; ?>
                                          @endforeach
                        ...
                        <div class="item">
                           <div class="col-lg-12">
                              <div class="row" style="margin-top: 5px;">
                                 ...
                                 <div class="col-xs-12 col-lg-6 calpro6">
                                    <div class="col-xs-4 col-lg-4"><img class="proimg" src="{{ $product->non_featured_image }}"></div>
                                    <div class="col-xs-8 col-lg-8">
                                       <strong>{{$product->name}}</strong><br>
                                       <small>{{$product->price}}</small><a href="{{ url('shop', $product->slug) }}"><i style="margin-left: 10px; height: 25px; width: 25px; border-radius: 50px; background-color: #E5E7E9; color:white; padding: 5px 0px 0px 5px;" class="fa fa-shopping-cart" aria-hidden="true"></i></a>
                                    </div>
         ...
         <div class="row brands">
            <div class="col-xs-5 col-sm-6 col-md-2 col-lg-2 colbrand"><img class="braimg" src="{{asset('uploads/Brand/brand22.jpg')}}"></div>
      ...
      <div class="row footer">
         <div class="col-xs-12 col-lg-3 text-center">
            <img class="fooimg" style="color:green; margin-top: 15px" src="{{asset('uploads/settings/logo1.png')}}" height="40">
            <br>
            <p class="para" style="font-size: 18px; margin-bottom: 10px">A Social Commerce platform for Authentic &amp; Halal-focused lifestyle. By the year 2023, we will be in over 45 countries, with 45 domestic platforms – with 80% of the products from international market, 20% local products.</p>
            
            <div class="row flag">
               <h5 style="font-family: poppins;  margin-top: 45px;">Our Platform</h5>
         ...
         <div class="col-lg-2 text-center" style="margin-top: 20px">
            ...
            <h5 style="font-family: poppins; margin-top: 30px; margin-bottom: 5px">Business</h5>
            <li>
         ...
         <div  class="col-lg-3 text-center payment" style="margin-top: 25px">
            <h5 style="font-family: poppins">Secure Payment</h5>
            <br>
            <div class="row col2">
            ...
            <div class="row col2 plat">
               <h5 style="font-family: poppins">Our Platform</h5>
            ...
            <div class="row col2" style="margin-top: 100px; margin-right: 30px;">
               <form style="margin-top: -70px">
                  <div class="input-group">
                     <input class="input" type="text" style="height: 40px; width: 150px; border-top-left-radius: 10px; border-bottom-left-radius: 10px; border:solid 1px #145A32; padding-left: 10px; color:grey"  placeholder="Email Address"><button class="btn btn" style="background-color: #145A32; color:white; font:normal; height: 40px; border-top-right-radius: 10px; border-bottom-right-radius: 10px; margin-top: -3px;">Subscribe</button>
                  </div>
               </form>
               <div class="row" style="display: inline;">
                  <h5 style="font-family: bold;">Follow Us</h5>
               ...
               <div class="row text-center para2">
                  <h5>A product by</h5>
                  <div style="height: 100px; width: 100px; margin: auto; border-radius: 80px; background-color: white; padding: 30px 0px 0px 0px">
                     <img height="90" width="90" src="{{asset('uploads/settings/logo1.png')}}" class="img-fluid">
                  </div>
               </div>
            </div>
         </div>
    ...
    width: 100%;
         ...
         border: solid #086E38 1px; 
         color: #086E38;
         padding: 5px 25px 0px 25px; height: 35px; color:086E38; margin: 0px 10px 0px 0px; 
         font: poppins;
         } 
         .btn3{
       border-radius:20px;
         ...
         border: solid #086E38 1px; 
         color: #086E38;
         padding: 5px 10px 0px 6px; height: 35px; color:086E38; margin: 0px 10px 0px 0px; 
         font: poppins;
         } 
         ul li .top:hover{
        ...
        .footer a, .footer p, .footer h1 {
         ...
         .h4{
            font-family: poppins; margin-bottom: 37px
         }
         .plat{
            margin-top:  90px;
         }
