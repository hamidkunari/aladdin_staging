...
<script src="https://cdn.agora.io/sdk/web/AgoraRTCSDK-2.8.0.js"></script>
  ...
  <h1 style="border-bottom:solid 1px #F2F3F4; width: 95%; font:normal ">{{auth::user()->name}} LiveStreaming</h1>
  <div class="container-fluid p-0">
				<div id="main-container">
					...
					<div id="buttons-container" style="margin-left: -340px" class="row justify-content-center mt-3">
					...
					<div id="full-screen-video" style="margin: 80px 0px 0px 0px; border-radius: 3px;">
						<div class="" style="margin: 0px -170px -160px 0px; padding-bottom: -50px;">

						<h4 class="text-right" >Select Product</h4>
						<form action="{{ route('livestreaming.store') }}" method="POST">
          @csrf
						<select name="product_id" class="form-control" style="width: 300px;margin-left: 560px;">
                        @foreach($listproducts as $product)
                        <option value="{{$product->name}}">{{$product->name}}</option>
                        <!-- <option value="">Samsung</option>
                        <option value="">IPone</option>
                         <option value="">Pepsi</option>
                        <option value="">Shoes</option>
                        <option value="">Dell</option> -->
                        @endforeach
						</select>
						<input name="title" style="width: 300px;margin-left: 560px; margin-top: 5px;" type="text" placeholder="LiveStreaming Title" class="form-control">
						<button style="margin-left: 560px; background-color: #145A32; color:white" class="btn btn" name="submit">Post product</button>
	...
	<script src="{{asset('livestream/js/agora-broadcast-client.js')}}"></script>
	<script src="{{asset('livestream/js/agora-screen-client.js')}}"></script>
	<script src="{{asset('livestream/js/ui.js')}}"></script>
<script>
