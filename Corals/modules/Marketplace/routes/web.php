...
Route::group(['prefix' => 'shop', 'as' => 'shop.'], function () {
    ...
    Route::get('autocomeplete/{store?}', ['as' => 'autoComplete', 'uses' => 'ShopPublicController@autoCompleteProductSearch']);
...
// Home pages Route
Route::get('',['as' => 'front', 'uses' => 'ShopPublicController@front']);


// New arrivel product Route
Route::get('newarrivel',['as' => 'newarrivel', 'uses' => 'ShopPublicController@newarrivel']);


// LiveStreaming front page
Route::get('watchstreaming',['as' => 'front', 'uses' => 'ShopPublicController@watchdetails']);

Route::get('vendor_detail/{vendor_id}', 'ShopPublicController@vendor_detail');
...
Route::get('marketplace/shipping-order', 'OrdersController@order_shipping');
Route::get('marketplace/followers','FollowController@index');
